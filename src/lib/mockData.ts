...
export const mockCompanies: Company[] = [
  {
    ...
    short_description: 'Empresa parceira da Redde People com oportunidades em atendimento, apoio pedagógico e operação.',
    about_text:
    ...
    why_work_here: 'Ambiente de crescimento, clareza de função e processo seletivo organizado com apoio da Redde People.',
  ...
  },
  {
    ...
    why_work_here: 'Processo seletivo estruturado com apoio da Redde People.',
...
export const mockApplications: Application[] = [
  {
    ...
    resume_file_path: 'applications/demo/mariana-costa.pdf',
    status: 'novo',
    lgpd_consent: true,
  ...
  },
  {
    ...
    resume_file_path: 'applications/demo/rafael-lima.pdf',
    status: 'em_analise',
    lgpd_consent: true,
    source: 'portal_publico',
    created_at: now,
...
export const mockProfiles: Profile[] = [
  ...
  },
  {
    ...
    email: 'recrutador@cliente.com.br',
...
export const mockSiteContents: SiteContent[] = [
  {
    ...
    body: 'Veja vagas abertas em empresas parceiras da Redde People e envie seu currículo de forma simples, rápida e segura.',
  ...
  },
  {
    ...
    body: null,
    button_label: 'Falar com a Redde People',
    button_url: 'mailto:contato@reddepeople.com.br',
    is_active: true,
    created_at: now,
    updated_at: now,
  },
